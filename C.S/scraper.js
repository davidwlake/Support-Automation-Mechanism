...
if(accountid !== undefined || accountid !== null ){
        ...
        var url = "https://dealertrack-production.my.salesforce.com/00O32000004mUKC?pv0=" + accountid + "&?" + encodeURIComponent(JSON.stringify(template))+"?"+encodeURIComponent(JSON.stringify(config));
